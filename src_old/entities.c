...
float *entity_pos_x = NULL;
float *entity_pos_y = NULL;

uint32_t current_entities = 0;
uint32_t entity_pool_size = 0;
uint32_t new_entity_pool_size = 16;
...
void resize_entity_array() {
    ...
    entity_pos_x = tracked_realloc(entity_pos_x, new_entity_pool_size * sizeof(float));
    entity_pos_y = tracked_realloc(entity_pos_y, new_entity_pool_size * sizeof(float));
